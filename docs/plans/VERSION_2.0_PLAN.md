...
9. **No Alembic migrations during 2.0 implementation.** There are no
   ...
   **Superseded 2026-07-11 (WI-15):** this implementation-phase policy has
   ended. The 2.0 schema is frozen and real autogenerated Alembic revisions now
   stack on top of `0010`. See the `0010` docstring, `docs/UPGRADING.md`, and the
   root `CHANGELOG.md`.
